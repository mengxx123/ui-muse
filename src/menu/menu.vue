<template>
    <div class="ui-menu" tabindex="0" v-clickoutside="clickoutside" @keydown="handleKeydown"
         :style="{'width': contentWidth}">
        <div ref="list" class="ui-menu-list" :style="{'width': contentWidth, 'max-height': maxHeight + 'px'}"
             :class="menuListClass">
            <slot></slot>
        </div>
    </div>
    ...
    export default {
        ...
        computed: {
            ...
            menuListClass () {
                ...
                const classNames = []
                if (desktop) classNames.push('ui-menu-destop')
