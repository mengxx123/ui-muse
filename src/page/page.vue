<template>
    <div class="ui-page ui-page-common">
        <div class="ui-page-content" :style="{'left': offset}">
            <header class="ui-page-header" :style="{'left': offset}" v-if="!embed">
            ...
            <main class="ui-page-body" :style="{top: embed ? '0' : '64px'}">
        ...
        <ui-drawer :open="drawerVisible" :docked="this.isPc" @close="toggleDrawer()" slot="drawer">
