<template>
  <div id="app">
    <ui-appbar v-if="!isHomePage" :zDepth="0" :title="title === 'index' ? '' : $t(title)" class="example-appbar" :class="{'nav-hide': !open}">
      <ui-icon-button @click="toggleNav" icon="menu" slot="left"/>
      <ui-icon-button slot="right" href="https://github.com/museui/muse-ui" icon=":mudocs-icon-custom-github"/>
    </ui-appbar>
